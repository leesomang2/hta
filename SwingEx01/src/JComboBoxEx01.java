...
public class JComboBoxEx01 extends JFrame {
	...
	public JComboBoxEx01() {
		...
		//comboBox.setModel(new CustomComboBoxModel1()); //클래스로 가져오기
		comboBox.setModel(new CustomComboBoxModel2());  //Array 클래스로 가져오기
		...
		btn.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				System.out.println(comboBox.getSelectedIndex()); //인덱스 번호 알려줌
				System.out.println((String)comboBox.getSelectedItem()); // 내용가져오기
			}
		});
		btn.setBounds(12, 43, 122, 23);
		contentPane.add(btn);
	}
}
