	...
	public JTextFieldEx01() {
		...
		btn1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				//lbl1.setText(textField1.getText()); //Text에 입력한내용 라벨로 출력
				
				
				//lbl1.setText(passwordField.getText());  밑에껄로쓰기
		...
		lbl1.setBounds(12, 263, 560, 23);
		contentPane.add(lbl1);
		
		passwordField = new JPasswordField();   //암호화 아님 주의
